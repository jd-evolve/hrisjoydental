<div class="page-inner">
    ...
    <div class="card">
        <div class="card-body">
            <table id="datatable-accpersonalia" class="table-responsive display nowrap table table-striped table-hover" >
                <thead>
                    <tr>
    ...
    <div class="modal fade" id="modal-setuju" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false">
        <div class="modal-dialog modal-xs modal-dialog-centered" role="document">
            <div class="modal-content">
                <form id="form-alasan-setuju" novalidate="novalidate" enctype="multipart/form-data" accept-charset="utf-8">
